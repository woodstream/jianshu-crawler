...
func httpGet(url string) (content string, statusCode int) {
	...
	if err1 != nil {
		statusCode = -100
		fmt.Printf("Get请求%s返回错误:%s", url, err1)
		return
	}
...
func main() {
	httpGet("http://www.jianshu.com/u/4ca93d60a9fe")
	// httpRequest("http://www.jianshu.com/users/4ca93d60a9fe/collections_and_notebooks?slug=4ca93d60a9fe");
	// httpRequest("http://www.jianshu.com/users/f8ff63b17fc7/publications?page=1&count=100");
}
